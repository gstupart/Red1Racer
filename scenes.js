const LEVEL_ONE = {
    ...
    player: {x: 400, y: 1360, degree: Math.PI / 2},
    // player: {x: 17000, y:4900, degree: Math.PI / 2},
    AIRacer: [
        {x: 400, y:1460, degree: Math.PI / 2},
        {x: 400, y:1560, degree: Math.PI / 2},
    ],
...
const LEVEL_TWO = {
    ...
    player: {x: 140, y: 3250, degree: Math.PI / 2},
    AIRacer: [
        {x: 140, y:3350, degree: Math.PI / 2},
        {x: 140, y:3450, degree: Math.PI / 2},
    ],
    AIWeapon: {type: MissileType.MAVERICK},
    offRoad: [
